...
CLDBDoSomeStuff       (+0x10E0) — URL/NAVIGATION HANDLER
  Same code as CLDBDoSomeOtherStuffs but at a different entry point.
  Both share the same function body. The export table lists them
  as separate ordinals but they execute identical code.
